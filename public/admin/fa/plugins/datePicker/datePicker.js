            ...
            for (var col = 0; col < 6; col++) {
                ...
                if (cellValue > 0 && cellValue <= getMonthDays(date)) {
                    ...
                    td.onclick = function () {
                        ...
                        document.getElementsByClassName("fromDate")[0].setAttribute("value", "12");
                        // $('#fromDate').attr('value' , 12);
                    };
...
var PersianDatePicker = new DatePickers();

DatePickers.Show = function (textBox, today, holidays) {
    PersianDatePicker.show(textBox, today, holidays);
};
