            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-7 col-sm-7">
                        <div class="black pt-5">Contact<span class="yellow ml-3">Kargo</span></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-5">
                                <div class="contact_name">
                                    <div class="contac_title">Contact us</div>
                                    <div class="col-12" style="padding: 1px 16px;">
                                        @include('layout.error')
                                    </div>
                                    <form action="{{url('/contact-us')}}" method="post">
                                        @csrf
                                        <div class="contact_input mb-4 mt-4"><input type="text" name="name" placeholder="Name" required></div>
                                        <div class="contact_input mb-4 mt-4"><input type="text" name="email" placeholder="Email" required></div>
                                        <div class="contact_texta mb-4 mt-4"><textarea placeholder="Message" name="message" required></textarea></div>
                                        <div class="contact_send mb-4 mt-4"><button type="submit">Send</button></div>
