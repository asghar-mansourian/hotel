...
<li class="{{url()->current() === url('/addressesabroad') ? 'active_li' : ''}}">
    <a href="{{url('/addressesabroad')}}"><i class="fas fa-search-location"></i><span class="use_dis_no">{{__('member.myaddressesabroad')}}</span></a>
</li>
