...
@section('title')
    {{__('admin.dashboard')}}  | {{__('admin.addpage')}}
@endsection
...
@section('main')
    <form class="form" method="post" id="mainForm" action="{{url('admin/pages/store')}}">
        @csrf
        <div class="row">
...
@section('crumb')
    @component('admin.components.crumb')
        ...
        @slot('items')
            ...
            <li class="breadcrumb-item active"><i class="fe fe-clipboard mr-2 fs-14"></i>{{__('admin.addpage')}}</li>
        @endslot
    @endcomponent
@endsection
