                                    ...
                                    <form action="{{ url('admin/register') }}" method="post">
                                        ...
                                        <div class="card-body">
                                            <div class="text-center title-style mb-6">
                                                <h1 class="mb-2">{{__('admin.register')}}</h1>
                                                <hr>
                                                <p class="text-muted">{{__('admin.createnuser')}}</p>
                                            </div>
                                        ...
                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password Confirm" name="password_confirmation" required
                                        ...
                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                <label class="custom-control custom-checkbox">
                                                    ...
                                                    <span class="custom-control-label"><a href="terms.html" class="">{{__('admin.Agreepolicy')}}</a></span>
                                                </label>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                                    <button type="submit" class="btn  btn-primary btn-block px-4">{{__('admin.createnuser')}}</button>
                                                </div>
                                            </div>
                                            <div class="text-center pt-4">
                                                <div class="font-weight-normal fs-16">{{__('admin.alreadyhaveaccount')}} <a class="btn-link font-weight-normal" href="{{route('login')}}">Login Here</a></div>
                                            </div>
                                        </div>
