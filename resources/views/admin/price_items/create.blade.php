...
@section('main')
    <form class="form" method="post" id="mainForm" enctype="multipart/form-data" action="{{url('admin/price-items/store')}}">
        @csrf
        <div class="row">
...
@section('scriptCustom')
    @component('admin.components.script.priceItemFormScript')
        @slot('detailFormUrlValue')
            ../../../admin/price-items
        @endslot
    @endcomponent
    @component('admin.components.script.priceItemAppend')
        @slot('id')
            fields
        @endslot
    @endcomponent
