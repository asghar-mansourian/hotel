            ...
            <div class="row">
                <div class="predefined_styles">
                    <div class="swichermainleft">
                        <div class="p-3">
                            <a href="../index.html" class="btn btn-primary btn-block mt-0">View Demo</a>
                            <a href="#" class="btn btn-secondary btn-block">Buy Now</a>
                            <a href="https://themeforest.net/user/sprukosoft/portfolio"
                               class="btn btn-warning btn-block">Our Portfolio</a>
                        </div>
                    </div>
                    <div class="swichermainleft">
                        <h4>Navigation Style</h4>
                        <div class="pl-3 pr-3">
                            <a class="btn btn-info btn-block" href="../Horizontal-Light/index.html">
                                Horizontal
                            </a>
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="switch_section">
                            <div class="switch-toggle d-flex">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch3"
                            ...
                            <div class="switch-toggle d-flex">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch14"
                    ...
                    <div class="swichermainleft">
                        ...
                        <div class="switch_section">
                            <div class="switch-toggle d-flex light-switcher">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch10"
                                                                 class="onoffswitch2-checkbox">
                            ...
                            <div class="switch-toggle d-flex dark-switcher">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch13"
                                                                 class="onoffswitch2-checkbox">
                            ...
                            <div class="switch-toggle d-flex">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch11"
                                                                 class="onoffswitch2-checkbox">
                            ...
                            <div class="switch-toggle d-flex">
                                ...
                                <div class="onoffswitch2"><input type="radio" name="onoffswitch2" id="myonoffswitch12"
                                                                 class="onoffswitch2-checkbox">
