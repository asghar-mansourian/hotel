    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                ...
                <span class="side-menu__label">country details</span><i class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
                <li><a href="{{url('admin/countries/details')}}" class="slide-item">details</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{url('admin/payments')}}" class="slide-item">Payments</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{url('admin/branches')}}" class="slide-item">Show</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a href="{{url('admin/order-items')}}" class="slide-item">Show Order Items</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{url('admin/calculatores')}}" class="slide-item">{{__('admin.showcalculator')}}</a></li>
            </ul>
        </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a href="{{url('admin/settings')}}" class="slide-item">Show Setting</a></li>
            </ul>
        </li>
