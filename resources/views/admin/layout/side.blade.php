...
{{--        <li class="side-item side-item-category mt-4">Main</li>--}}
        <li class="slide">
            <a class="side-menu__item" href="{{url('admin/home')}}">
                ...
                <span class="side-menu__label">{{__('custom.admin.panel.title')}}</span><span class="badge badge-danger side-badge">Main</span></a>
        </li>
        <li class="slide">
