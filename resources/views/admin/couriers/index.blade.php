...
{{--        </div>--}}
        <div class="col-12" id="">
            ...
            @component('admin.components.panel')
                ...
                @slot('items')
                    @component('admin.components.table' , ['sortType'=>$sortType, 'sortField'=>$sortField, 'records' => $couriers , 'selects' => ['id'  ,['stock' , 'address'],'district' , 'city' , 'street' , 'home' , 'phone' , 'address'] , 'options' => ['show', 'delete']])
                        @slot('paginate')
                            {{$couriers->links()}}
                        @endslot
                        @slot('url')
