    ...
    <div class="row">
        ...
        <div class="col-12" id="">
            @component('admin.components.panel')
                ...
                @slot('items')
                    @component('admin.components.table' , ['sortType'=>$sortType,'sortField'=>$sortField,'records' => $calculatores , 'selects' => ['id' , 'from' , 'to' , [ 'country','name'] , 'currency'] , 'options' => ['edit' , 'delete']])
                        @slot('paginate')
                            {{$calculatores->links()}}
                        @endslot
                        @slot('url')
