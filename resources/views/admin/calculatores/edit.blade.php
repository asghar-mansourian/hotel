...
@section('main')
    <form class="form" method="post" id="mainForm" action="{{url('admin/calculatores/update/' . $calculator->id)}}">
        @csrf
        <div class="row">
                        ...
                        @component('admin.components.form.optionLabel')
                            ...
                            @slot('items')
                                ...
                                @foreach($countries as $country)
                                    <option
                                        value="{{$country->id}}" @if($country->id == $calculator->country_id) selected @endif>{{$country->name}}</option>
                                @endforeach
                            @endslot
                        @endcomponent
                        ...
                        @component('admin.components.form.optionLabel')
                            ...
                            @slot('items')
                                ...
                                @foreach($units as $unit)
                                    <option
                                        value="{{$unit->id}}" @if($unit->id == $calculator->unit_id) selected @endif>{{$unit->title}}</option>
                                @endforeach
                            @endslot
                        @endcomponent
