        ...
        <div class="col-12" id="">
            @component('admin.components.panel')
                @slot('header')
                    ...
                    <a href="{{url('/admin/projects/create')}}" class="btn btn-sm btn-info ml-auto"><i class="fe fe-plus-circle mr-1 "></i>
                        {{__('admin.add_project')}} </a>
                @endslot
                            ...
                            <table class="table table-striped card-table table-vcenter text-nowrap table-bordered table-hover">
                                ...
                                @foreach($projects as $project)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('admin/projects/delete/'. $project->id)}}"
                                               class="btn btn-sm btn-danger delete" data-toggle="tooltip"
                                               title data-placement="top" data-value="{{$project->id}}" data-original-title="Delete">
