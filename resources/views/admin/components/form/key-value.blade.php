<div class="form-group row">
    ...
    <div class="col-md-9">
        <input class="form-control " name="names_ru[0]" type="text" placeholder="enter the keyword name"
               value="{{ $name_ru ?? '' }}" id='names_ru0'>
    </div>
    ...
    <div class="col-md-9">
        <input class="form-control " name="values_ru[0]" type="text" placeholder="enter the value name"
               value="{{ $value_ru ?? '' }}" id='values_ru0'>
    </div>
