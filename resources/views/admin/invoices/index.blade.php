...
{{--        </div>--}}
        <div class="col-12" id="">
            ...
            @component('admin.components.panel')
                ...
                @slot('items')
                    @component('admin.components.table' , ['sortType'=>$sortType, 'sortField'=>$sortField, 'records' => $invoices , 'selects' => ['id' ,'status_type', 'shop' , 'price' , ['user' , 'email']] , 'options' => ['show', 'status_type' , 'delete']])
                        @slot('paginate')
                            {{$invoices->links()}}
                        @endslot
                        @slot('url')
