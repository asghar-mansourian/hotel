...
@section('title')
    {{__('admin.dashboard')}} | {{__('admin.add_cancel_reason_orders')}}
@endsection
...
@section('main')
    <form class="form" method="post" id="mainForm" action="{{url('admin/cancel-reason-orders/store')}}">
        @csrf
        <div class="row">
                    ...
                    @slot('items')
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea class="form-control" name="description" placeholder="" cols="30" rows="4"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-md-3 form-label my-auto">
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea class="form-control" name="description_ru" placeholder="" cols="30" rows="4"></textarea>
                            </div>
                        </div>
...
@section('crumb')
    @component('admin.components.crumb')
        ...
        @slot('items')
            ...
            <li class="breadcrumb-item active"><i class="fe fe-clipboard mr-2 fs-14"></i>{{__('admin.add_cancel_reason_orders')}}</li>
        @endslot
    @endcomponent
@endsection
