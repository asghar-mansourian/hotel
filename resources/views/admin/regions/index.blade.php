    ...
    <div class="row">
        ...
        <div class="col-12" id="">
            @component('admin.components.panel')
                ...
                @slot('items')
                    @component('admin.components.table' , ['sortType'=>$sortType,'sortField'=>$sortField,'records' => $regions , 'selects' => ['id' , 'name' , 'description' , [ 'country','name']], 'options' => ['show' , 'edit' , 'delete']])
                        @slot('paginate')
                            {{$regions->links()}}
                        @endslot
                        @slot('url')
