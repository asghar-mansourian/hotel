...
@section('title')
    {{__('admin.dashboard')}}  | {{__('admin.addadmin')}}
@endsection
...
@section('main')
    <form class="form" method="post" id="mainForm" action="{{url('admin/admins/store')}}">
        @csrf
        <div class="row">
...
@section('crumb')
    @component('admin.components.crumb')
        ...
        @slot('items')
            ...
            <li class="breadcrumb-item active"><i class="fe fe-clipboard mr-2 fs-14"></i>{{__('admin.admins')}}</li>
        @endslot
    @endcomponent
@endsection
