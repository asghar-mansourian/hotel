...
class User extends Authenticatable implements JWTSubject
{
     ...
     */
    protected $fillable = [
        'name', 'family', 'email', 'password', 'sms_code', 'sms_verified_at', 'code', 'verified', 'phone', 'serial_number', 'citizenship', 'birthdate', 'gender', 'region_id', 'branch_id', 'fin', 'address', 'token'
    ];
    /**
